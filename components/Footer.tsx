    ...
    <footer className="site-footer">
      <div className="footer-top">
        ...
        <div className="footer-col">
          ...
          <a href="https://www.linkedin.com/company/ameya-sonic-opteo-system/" target="_blank" rel="noopener noreferrer">LinkedIn (Company) ↗</a>
          <a href="https://www.linkedin.com/in/dr-soni-gupta-198724141/" target="_blank" rel="noopener noreferrer">LinkedIn (Founder) ↗</a>
          <a href="https://jsdl.in/RSL-QCP1782016899" target="_blank" rel="noopener noreferrer">JustDial ↗</a>
          <a href="mailto:contact@ameyasonicopteosystem.com">Email ↗</a>
        </div>
